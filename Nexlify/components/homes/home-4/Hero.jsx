        ...
        <div className="section-outer panel pt-9  xl:pt-10">
          <div className="container xl:max-w-xl pt-4">
            <div className="section-inner panel pt-0 lg:pt-4 xl:pt-0 ">
                ...
                <div>
                  ...
                  >
                    <div className="cstack gap-2 py-1 px-1 pe-3 bg-white bg-opacity-10 rounded-pill fs-7 text-white">
                      <span className="rounded-pill bg-primary px-2 lh-0 py-narrow ">
                        NEW
                      </span>
                      <span className="">Theme 4 Now Available!</span>
                    </div>
              ...
              <div
                className="panel mb-6 pb-6 prespective"
                data-anime="scale: [1.2, 1]; opacity: [0, 1]; easing: easeOutCubic; duration: 750; delay: 500;"
              >
                <figure
                  className=" scroll-animation featured-image m-0 rounded-2 lg:rounded-4  overflow-hidden border border-2 border-gray-10 mx-auto position-relative"
                  ref={parallax.ref}
