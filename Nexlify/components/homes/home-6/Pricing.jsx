  ...
  return (
    ...
    >
      <div className="section-outer panel py-4 overflow-hidden md:py-6 xl:py-10 mx-2  text-white bg-opacity-10  bg-section">
        <div className="container xl:max-w-xl mx-auto px-0 ">
              ...
              >
                ...
                >
                  <li
                    className={
                      !isYearly
                        ? ' text-white bg-black rounded-pill py-narrow'
                ...
                >
                  {tiers3.map((tier, index) => (
                    <div key={index} className="tier-wrapper">
                      <div className="tier panel vstack gap-2 pb-6 xl:gap-4 px-3 py-4 sm:p-4 lg:p-6 pricing-card-home-6">
                        {tier.isPopular && (
