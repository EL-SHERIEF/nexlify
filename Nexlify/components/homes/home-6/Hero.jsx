        ...
        <div className="section-outer panel pt-9">
          <div className="container xl:max-w-xl pt-4">
            <div className="section-inner panel pt-3 ">
                ...
                <div>
                  ...
                  >
                    <h1 className="h1 sm:display-5 md:display-4 lg:display-4 xl:display-3 mb-1 text-white">
                      <span className="opacity-40">Turn data</span> <br />
                      into decisions
                    </h1>
                    <p className="fs-5 fw-light text-white opacity-50">
                      Powerful analytics and reporting that empowers your team
                      to make smarter business choices.
                    </p>
                    <Link
                      href={`/page-pricing`}
              ...
              <div
                className="panel prespective mt-6 pt-6"
                data-anime="scale: [1.2, 1]; opacity: [0, 1]; easing: easeOutCubic; duration: 750; delay: 500;"
              >
                <figure
                  className="bg-blur-lg z-2 scroll-animation featured-image mt-8 mb-0 pb-0 px-1 rounded-2 lg:rounded-4  overflow-hidden  mx-auto position-relative"
                ...
                <figure
                  className="home-6-doodle scroll-animation featured-image m-0 mx-auto position-absolute mx-auto"
                  ref={parallax.ref}
                >
                  <Image
                    className="w-full h-full position-relative opacity-70"
