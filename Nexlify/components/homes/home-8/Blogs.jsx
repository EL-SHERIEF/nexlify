                  ...
                  >
                    {slidesData2.map((slide) => (
                      <SwiperSlide key={slide.id}>
                        <article className="post type-post panel overflow-hidden vstack p-1 m-2 bg-box box-style-sm text-dark duration-150 hover:-translate-y-1 rounded-1-5">
                          ...
                          <div className="panel vstack gap-1 p-2">
                            ...
                            <div className="content vstack justify-between gap-narrow">
                              ...
                              <Link
                                href={`/blog-details/${slide.id}`} // Link added directly in JSX
                                className="uc-link text-primary fs-7 xl:fs-6 fw-bold hstack gap-1 sm:mt-1 xl:mt-2"
                              >
                                <span>Read post</span>
                    ...
                    <div className="swiper-pagination position-relative mt-4 spdt1 text-primary" />
                  </Swiper>
                </div>
              </div>
