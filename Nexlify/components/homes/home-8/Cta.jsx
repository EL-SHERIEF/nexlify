...
export default function Cta() {
  return (
    <div
      id="uc_cta"
      className="uc-cta panel overflow-hidden z-1 p-4"
        ...
        <div className="container">
          <div className="section-inner panel">
            ...
            <span className="custom-tag mb-2">
              ...
              <h2 className="h1 fw-light m-0 text-inherit ls-1 text-dark">Build AI-Powered Marketing Now!</h2>
              <p className="fs-6 fw-light">Automate lead generation and customer engagement in diverse and dynamic real-world settings</p>
              <div
                className="panel d-flex flex-column flex-wrap items-center justify-center gap-1"
                data-anime="onview:-100; targets: >*; translateY: [48, 0]; opacity: [0, 1]; easing: easeOutCubic; duration: 500; delay: anime.stagger(100, {start: 200});"
              >
                  <a href="#" className="btn btn-md btn-primary border px-3 lg:px-5 w-auto">
