    ...
    <div id="pricing" className="pricing section panel overflow-hidden">
      <div className="section-outer panel py-6 xl:py-9 lg:mx-2 mt-2">
        ...
        <span className="custom-tag-sm mb-2"> Transparent Pricing, No Surprises</span>
              ...
              >
                <ul
                  className="box-style bg-box uc-subnav uc-subnav-pill gap-1 uc-child-width-expand rounded-1-5 p-narrow max-w-xs mx-auto"
                ...
                <p className="text-center mt-4 lg:mt-6 bg-little-elements w-fit mx-auto px-3 py-2 opacity-70 rounded-1-5 gap-1 d-flex">
                  ...
                  <div className="vstack items-start justify-between gap-2 lg:gap-4 p-2 xl:p-3 min-h-200px bg-box box-style-sm rounded-2">
                    <span className="icon mb-narrow bg-box box-style-sm p-1 rounded-2">
                      <Image
                        className="w-40px"
                        alt="icon"
                        src="/assets/images/custom-icons/home-5/icon-7.svg"
                        width={24}
                        height={24}
                      />
                    </span>
                  ...
                  <div className="vstack items-start justify-between gap-2 lg:gap-4 p-2 xl:p-3 min-h-200px bg-box box-style-sm rounded-2">
                    <span className="icon mb-narrow bg-box box-style-sm p-1 rounded-2">
                      <Image
                        className="w-40px"
                        alt="icon"
                        src="/assets/images/custom-icons/home-5/icon-8.svg"
                        width={24}
                        height={24}
                      />
                    </span>
                  ...
                  <div className="vstack items-start justify-between gap-2 lg:gap-4 p-2 xl:p-3 min-h-200px bg-box box-style-sm rounded-2">
                    <span className="icon mb-narrow bg-box box-style-sm p-1 rounded-2">
                      <Image
                        className="w-40px"
                        alt="icon"
                        src="/assets/images/custom-icons/home-5/icon-12.svg"
                        width={24}
                        height={24}
                      />
                    </span>
                  ...
                  <div className="vstack items-start justify-between gap-2 lg:gap-4 p-2 xl:p-3 min-h-200px bg-box box-style-sm rounded-2">
                    <span className="icon mb-narrow bg-box box-style-sm p-1 rounded-2">
                      <Image
                        className="w-40px"
                        alt="icon"
                        src="/assets/images/custom-icons/home-5/icon-10.svg"
                        width={24}
                        height={24}
                      />
                    </span>
                  ...
                  <div className="vstack items-start justify-between gap-2 lg:gap-4 p-2 xl:p-3 min-h-200px bg-box box-style-sm rounded-2">
                    <span className="icon mb-narrow bg-box box-style-sm p-1 rounded-2">
                      <Image
                        className="w-40px"
                        alt="icon"
                        src="/assets/images/custom-icons/home-5/icon-11.svg"
                        width={24}
                        height={24}
                      />
                    </span>
