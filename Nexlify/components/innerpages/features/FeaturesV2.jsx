...
export default function FeaturesV2() {
  ...
  return (
    <div
      id="features"
      className="features section panel scrollSpysection bg-section"
    >
      <div className="section-outer panel py-2 ">
        <div className="container xl:max-w-xl">
          <div className="section-inner panel">
            <div
              className="panel vstack justify-center gap-1 items-center max-w-600px lg:max-w-750px mx-auto px-2 lg:px-0 text-center pb-6"
            ...
            >
              ...
              <p className="fs-5 xl:fs-4 fw-light text-white text-center  opacity-50 py-narrow">
                Make data accessible and actionable for teams of all sizes.
              </p>
            </div>
            <div className="row child-cols-12 lg:child-cols-5 col-match g-4">
                ...
                >
                  ...
                  >
                    <div className="border border-1 text-white d-flex flex-row items-center gap-1 justify-center rounded-pill w-fit bg-black">
                      <span className="fw-medium fs-7 bg-primary rounded-pill px-1 m-narrow">
                        Nexlify
                      </span>
              ...
              >
                ...
                <div
                  className="panel ltr:ps-3 ltr:lg:ps-4 ltr:xl:ps-6 rtl:pe-3 rtl:lg:pe-4 rtl:xl:pe-6 mt-4"
                  ref={parallax2.ref}
                >
                  <Image
                    className="ltr:rounded-top-start-1-5 rtl:rounded-top-end-1-5"
