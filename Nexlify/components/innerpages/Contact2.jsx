...
export default function Contact2() {
  return (
    <div
      id="hero_header"
      className="hero-header section panel overflow-hidden bg-section"
    >
      <div className="section-outer panel pt-8 lg:pt-9 pb-6 sm:pb-8 lg:pb-9">
        <div className="container max-w-xl">
          ...
          >
            <div
              className="panel vstack justify-center items-center gap-3 max-w-600px py-4 mb-4 mx-auto px-2 lg:px-0 text-center"
            ...
            >
              ...
              <h1 className="h1 sm:display-5 md:display-4 lg:display-4 xl:display-3 mb-1 text-white">
                <span className="opacity-40">Questions?</span> <br />
                Let us help you
              </h1>
              <p className="fs-5 xl:fs-4 fw-light text-white text-center">
                <span className="opacity-50">Read the </span>
                <Link href={`/page-contact`}>FAQ </Link>
                <span className="opacity-50"> or send us a message.</span>
              </p>
            </div>
                ...
                <div className="order-0 lg:order-1 ">
                  ...
                  >
                    ...
                    <p className="text-center text-white mt-2">
                      Or Send us an
                      <a className="uc-link" href="mailto:hello@nexlify.co">
                        {' '}
                        email
                      </a>
                      .
