    ...
    >
      <div className="section-outer panel pb-4 lg:pb-6 xl:pb-9">
        <div className="container max-w-xl">
          <div
            className="section-inner panel p-3 py-6 lg:p-6 xl:p-8 rounded-2 border-1 border-black border overflow-hidden shadow-sm text-white"
            style={{
              borderRadius: '20px',
          ...
          >
            ...
            >
              <div className="vstack items-center gap-2 max-w-500px xl:max-w-600px">
                <span
                  className="fw-medium d-flex align-items-center px-2 py-1 bg-white bg-opacity-10 rounded-pill blur gap-1 m-0"
                ...
                <h2 className="h4 md:h3 lg:h2 m-0 text-inherit mt-1">
