      ...
      <div className="container max-w-xl">
        <div className="page-wrap panel vstack gap-4 lg:gap-6 xl:gap-8">
          ...
          <div className="page-content panel fs-6 md:fs-5">
            ...
            <h3 className="h4 md:h3 mt-3 lg:mt-6 mb-2">Disclaimers</h3>
            <p>
            ...
            <h3 className="h4 md:h3 mt-3 lg:mt-6 mb-2">Copyright Policy</h3>
            <p>
            ...
            <h3 className="h4 md:h3 mt-3 lg:mt-6 mb-2">General</h3>
            <p>
              Sit amet consectetur adipisicing elit. Sequi, cum esse possimus
              officiis amet ea voluptatibus libero! Dolorum assumenda esse,
              deserunt ipsum ad iusto! Praesentium error nobis tenetur at, quis
              nostrum facere excepturi architecto totam.
            </p>
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
              Inventore, soluta alias eaque modi ipsum sint iusto fugiat vero
