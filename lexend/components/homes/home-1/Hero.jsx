            ...
            <div className="section-inner panel">
              <div className="vstack gap-6 sm:gap-8 xl:gap-9">
                <div className="panel text-center max-w-850px mx-auto uc-dark">
                  ...
                  >
<span className="my-4 fw-medium d-flex align-items-center px-2 py-1 bg-white bg-opacity-10 rounded-pill blur" style={{border:'solid 1px rgba(255, 255, 255, 0.38)'}}>
