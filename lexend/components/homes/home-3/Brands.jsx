          ...
          <div className="section-inner panel">
            ...
            >
              ...
              <div className="panel mt-3 sm:mt-4">
                ...
                <div className="mt-5 mx-auto d-flex flex-row flex-sm-column flex-md-row flex-lg-row flex-wrap justify-center items-center gap-4 w-fit">   
                   <div className="cards-home-3-box p-1 d-flex flex-row justify-center items-start gap-2">
                  ...
                  <Image className="cards-home-3-box p-1 bg-white" src="/assets/images/review-logo/github.svg" width={62} height={62} style={{ height: "62px", width: "fit-content" }} alt="" />
                   <div className="flex-column justify-center items-start d-flex gap-1">
                    <div className="rounded-2 overflow-hidden d-flex flex-row border-gray-50 border-2 border w-fit">
                     ...
                     <p className="text-gray-300 fs-7">On Github</p>
                   </div>
                  </div>
                </div>
