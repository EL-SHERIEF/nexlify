        ...
        <div className="container max-w-xl">
          <div className="section-inner panel">
            ...
            >
              ...
              <div className="panel">
                <div className="row child-cols-12 sm:child-cols-6 lg:child-cols-4 justify-center g-2 xl:g-4">
                  {articles.map((article, index) => (
                    <div key={index}>
                      <article className="post type-post panel vstack gap-3 rounded-3 p-1 pb-3 cards-home-3-box bg-white">
                        <figure className="featured-image m-0 rounded ratio ratio-3x2 rounded-2 uc-transition-toggle overflow-hidden border border-1 border-black">
                          <Image
                            className="media-cover image uc-transition-scale-up uc-transition-opaque cards-home-3"
                            src={article.imgSrc}
                            width={1280}
                            height={854}
                            alt={article.imgAlt}
                      ...
                      <Link
                          className="fs-7 fw-medium text-none z-1  text-gray-800 bg-gray-25 cards-home-3-box py-narrow px-1 rounded-pill"
                          href={`/blog`}
                        ...
                        >
                          ...
                          <h3 className="h5 fw-medium xl:h4 m-0 text-start m-0">
                            <Link
                              className="text-none"
                              href={`/blog-details/${article.id}`}
                            >
              ...
              <Link
                href={`/blog`}
                className="uc-link text-white py-1 px-3 shadow-sm bg-primary border border-1 border-black fw-bold d-inline-flex items-center gap-narrow mt-2 rounded-pill"
              >
                <span>View more</span>
