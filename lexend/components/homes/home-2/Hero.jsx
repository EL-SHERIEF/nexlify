      ...
      <div className="section-outer panel py-6 xl:py-9 pt-9 lg:pt-10">
        ...
        <div className="container max-w-xl">
          <div className="section-inner panel py-4">
            ...
            <div className="row child-cols justify-center lg:justify-between items-center gy-4 sm:gy-6 gx-0 position-relative" style={{zIndex: 2}}>
              <div className="col-12 sm:col-10 lg:col-5">
                ...
                >
                  <span className="fw-medium d-flex align-items-center px-2 py-1 text-primary  rounded-pill blur gap-1 border-1 border border-black shadow-sm d-flex justify-center items-center gap-2 bg-white" style={{width:"fit-content"}}>
                   <div className="glowing-circle"></div> CRM Tool Workflow
                  </span>
                ...
                >
                  <div className="panel overflow-hidden gap-2 d-flex flex-row justify-center items-center">
                   ...
                   <Image
                      ...
                      alt="Main hero image"
                      src="/assets/images/template/feature-03.jpg"
                   ...
                   <Image
                    ...
                    />
                     ...
                     className="d-block h-250px"
                      alt="Main hero image"
                      src="/assets/images/template/feature-02.jpg"
                      style={{objectFit: "cover",borderRadius:"60px",width:"140px" }}
                      width="1280"
                      height="941"
                    />
                   ...
                   <Image
                      className="d-block h-250px"
                      alt="Main hero image"
                      src="/assets/images/template/feature-04.jpg"
                      style={{objectFit: "cover",borderRadius:"60px",width:"140px" }}
                      width="1280"
                      height="941"
                    />
