      ...
      <div className="section-outer panel pb-6 xl:pb-9">
        <div className="container max-w-xl">
          <div className="section-inner panel">
            <div
              className="panel vstack justify-center items-center gap-4 pt-4"
            ...
            >
              ...
              <h2 className="h4 sm:h3 lg:h2 m-0 text-center pb-2">
              ...
              >
                {testimonials3.map((testimonial, index) => (
                  <div key={index}>
                    <div className="px-3 sm:px-4 py-4 panel vstack justify-between gap-3 rounded-2 border border-black border-1 shadow-sm">
